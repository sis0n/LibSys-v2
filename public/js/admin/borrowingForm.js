document.addEventListener('DOMContentLoaded', () => {
  ...
  const populateCollaterals = async () => {
    ...
    try {
        const res = await fetch(`${BASE_URL}/api/admin/borrowingForm/getCollaterals`);
  ...
  setupCombobox('item_name', 'item_name_suggestions', 'item_name_suggestions_list', 'item_name_dropdown_arrow', 'api/admin/borrowingForm/getEquipments', 'equipment_id_hidden');
});