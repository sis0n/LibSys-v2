document.addEventListener('DOMContentLoaded', () => {
  ...
  const populateCollaterals = async () => {
    ...
    try {
        const res = await fetch(`${BASE_URL}/api/superadmin/borrowingForm/getCollaterals`);
  ...
  setupCombobox('item_name', 'item_name_suggestions', 'item_name_suggestions_list', 'item_name_dropdown_arrow', 'api/superadmin/borrowingForm/getEquipments', 'equipment_id_hidden');
});