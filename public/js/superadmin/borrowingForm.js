document.addEventListener('DOMContentLoaded', () => {
  ...
  fetchData('api/superadmin/borrowingForm/getCollaterals', 'collateral-list', 'collateralDropdownValue', 'collateral_id_hidden', 'collateralDropdownMenu', 'collateralDropdownBtn', 'collateral-item', 'collateral_id', 'name');
  fetchData('api/superadmin/borrowingForm/getEquipments', 'equipment-list', 'equipmentDropdownValue', 'equipment_id_hidden', 'equipmentDropdownMenu', 'equipmentDropdownBtn', 'equipment-item', 'equipment_id', 'equipment_name');
  ...
  document.getElementById('check-btn').addEventListener('click', async () => {
    ...
    try {
      const res = await fetch(`${BASE_URL}/api/superadmin/borrowingForm/checkUser`, {
        method: 'POST',
  ...
  document.getElementById('main-borrow-form').addEventListener('submit', async (e) => {
    ...
    try {
      const res = await fetch(`${BASE_URL}/api/superadmin/borrowingForm/create`, { method: 'POST', body: formData });
      const data = await res.json();
      Swal.close();
