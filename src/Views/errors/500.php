...
<head>
    ...
    <title>Library | 500 Internal Server Error</title>
    <link href="<?= defined('BASE_URL') ? BASE_URL : '' ?>/css/output.css" rel="stylesheet">
...
<body class="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-green-50 font-sans p-6 overflow-hidden">
    ...
    <div class="w-full max-w-md text-center relative z-10">
        ...
        <div class="flex justify-center mb-10">
            <img src="<?= defined('BASE_URL') ? BASE_URL : '' ?>/assets/library-icons/apple-touch-icon.png" alt="Library Logo" class="w-24 drop-shadow-sm opacity-90">
        </div>

        <div class="mb-10">
            <h1 class="text-8xl font-black text-gray-900 tracking-tighter leading-none">500</h1>
            <h2 class="text-xl font-bold text-gray-700 mt-4 uppercase tracking-[0.3em]">Server Error</h2>
        ...
        <p class="text-base text-gray-600 mb-12 leading-relaxed font-medium">
            Oops! Something went wrong on our end. We're currently working to fix it.
        </p>
